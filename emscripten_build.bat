...
set FLAGS= -std=c++11 -DNDEBUG -DVISUAL_DEBUG -DWEB -DGLM_FORCE_RADIANS %IDIRS% -s USE_SDL=2 -s USE_SDL_IMAGE=2 -s USE_LIBPNG=1 -s TOTAL_MEMORY=134217728 -O3 --use-preload-plugins --preload-file data
